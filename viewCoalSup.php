...
<?php
	if (isset($_POST['print'])) {
		...
		global $ConnectingDB;
		$sql = "SELECT * FROM coalsupplier WHERE status='Approved'";
		$stmt = $ConnectingDB->query($sql);

		$pdf->SetFont('Times','B',15);
		$pdf->Cell(27,6,'Summary of Approved Coal',0,1);
		$pdf->Ln(5);
		...
		$pdf->Cell(25,6,'Supplying Port',1,1);
		...
		while ($dataRaws = $stmt->fetch()) {
			...
			$pdf->Cell(25,6,$dataRaws['port'],1,1);
		}
		...
		$pdf->Output('D','Eligibal Suppliers.pdf');
	}
	?>
...
<head>
	...
	<title>View Coal Supplier</title>
</head>
<body>
	<!--NAVBAR-->
	...
	<header class="text-white bg-dark">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 p-2">
					<form class="" action="viewCoalSup.php" method="Post" enctype="multipart/form-data">
						<button type="print" style="border-color:white;" name="print" id="print" class="btn btn-dark btn-block">Print Approved List</button>
					</form>
				</div>
			</div>
		</div>
	...
	<section class="container py-2 mb-1">
		<div class="row">
			...
			<div class="row">
				<div class="col-md-12">
					<h5 class="text-center">View Applied Coal Suppliers</h5>
				</div>
			</div>
			<div class="col-lg-12">
				<table class="table table-striped table-hover">
					...
					<tr>
						...
						<td><a href="checkCoalSupplier.php?id=<?php echo $id;?>"><span class="btn bg-warning">View</span></a></td>
