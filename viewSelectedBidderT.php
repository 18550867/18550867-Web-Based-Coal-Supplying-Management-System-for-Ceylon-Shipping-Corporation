...
<head>
	...
	<title>View Coal Transport Selected Bidder</title>
</head>
<body>
	<!--NAVBAR-->
		...
		<div class="row">
			...
			<div class="col-lg-12">
				<table class="table table-striped table-hover">
					...
					AND offertrans.results='Approved'";
					$stmt = $ConnectingDB->query($sql);
					$sr=0;
					while ($dataRaws = $stmt->fetch()) {
						$id = $dataRaws["id"];
					...
					<tr>
						...
						<td><?php if (strlen($email)>15){$email = substr($email,0,10).'...';}
						 	echo $email; ?></td>
						<td><?php echo $qty; ?></td>
						<td><?php echo $total; ?></td>
						
						<td><a href="sendAward.php?id=<?php echo $id;?>"><span class="btn bg-warning">Add Job</span></a></td>
					</tr>
					<tbody>
					<?php } ?>
				</table>
