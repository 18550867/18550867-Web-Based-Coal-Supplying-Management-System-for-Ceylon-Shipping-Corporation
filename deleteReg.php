...
if (isset($_POST['submit'])) {
		global $ConnectingDB;
		$sql = "DELETE FROM register WHERE id = '$searchQueryParameter'";
...
<body>
	...
	<header class="text-white bg-dark">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h5 class="text-center">Delete Registration Notices </h5>
				</div>
			</div>
		</div>
	</header>
	...
	<section class="container py-2 mb-1">
		<div class="row">
			<div class="offset-lg-3 col-lg-6">
				...
				<form class="" action="deleteReg.php?id=<?php echo $searchQueryParameter; ?>" method="Post" enctype="multipart/form-data">
					<div class="card mb-2" style="border-color:black;">
						<div class="card-body">
							<div class="form-group">
								<label for="title"><span class="FieldInfo">Reg Id:</span></label>
								<input type="text" class="form-control" name="regId" id="regId" value="<?php echo $regId; ?>" readonly>
							</div>
							<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-lg-6">
									<button type="submit" name="submit" class="btn btn-block btn-danger">Confiremd Delete</button>
								</div>
							</div>
						</div>
					</div>
