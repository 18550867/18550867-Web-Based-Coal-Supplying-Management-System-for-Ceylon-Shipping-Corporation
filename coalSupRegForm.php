...
if (isset($_POST['submit'])) {
	...
	if (empty($companyName)||empty($address)||empty($telephone)||empty($fax)||empty($email)||empty($port)||empty($qty)||empty($experienceDoc)||empty($companyReg)||empty($finStmt)) {
		$_SESSION['ErrorMessage'] = "Please Fill the All Fields";
		RedirectTo("coalSupRegForm.php");
		...
		global $ConnectingDB;
		$sql = "INSERT INTO coalsupplier(cName,address,telephone,fax,email,port,coalSupply,experience,exDoc,regDoc,finDoc,datetime,type,status,password)";
		$sql .= "VALUES(:cName,:address,:telephone,:fax,:email,:port,:coalSupply,:experience,:exDoc,:regDoc,:finDoc,:datetime,:type,:status,:password)";
...
<head>
	...
	<title>Coal Supplier Registration</title>
</head>
<body>
	<!--NAVBAR-->
	...
	<header class="text-white bg-dark">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h5 class="text-center">Coal Supplier Registration</h5>
				</div>
			</div>
		</div>
	</header>
	...
	<section class="container py-2 mb-1">
		<div class="row">
			<div class="offset-lg-3 col-lg-6">
				...
				echo SuccessMessage();
				?>
				<form class="" action="coalSupRegForm.php" method="Post" enctype="multipart/form-data">
					<div class="card mb-2" style="border-color:black;">
						<div class="card-body">
							...
							<div class="form-group">
								<label for="coal supply"><span class="FieldInfo">Port of Coal Supply:</span></label>
								<input type="text" class="form-control" name="port" id="port">
							</div>
							<div class="form-group">
								<label for="quantity"><span class="FieldInfo">Do You Supply Above 1,000,000 MT Coal Supply for International Market Since 2021:</span></label>
							...
							<div class="form-group">
								<label for="Experiences"><span class="FieldInfo">Experience of Coal Supply for International Market:</span></label>
