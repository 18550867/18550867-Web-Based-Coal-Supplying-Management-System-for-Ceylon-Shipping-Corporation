...
if (isset($_POST['submit'])) {
	...
	if (empty($title)||empty($deadline)||empty($document)||empty($qty)) {
		...
		global $ConnectingDB;
		$sql = "INSERT INTO procurement(datetime,title,type,qty,author,document,deadline)";
		$sql .= "VALUES(:datetime,:title,:type,:qty,:author,:document,:deadline)";
...
<body>
	...
	<header class="text-white bg-dark">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h5 class="text-center">Add New Procurement</h5>
				</div>
			</div>
		</div>
	</header>
	...
	<section class="container py-2 mb-1">
		<div class="row">
			<div class="offset-lg-3 col-lg-6">
				...
				echo SuccessMessage();
				?>
				<form class="" action="addProc.php" method="Post" enctype="multipart/form-data">
					<div class="card mb-2" style="border-color:black;">
						<div class="card-body">
							<div class="form-group">
								<label for="title"><span class="FieldInfo">Title:</span></label>
								<input type="text" class="form-control" name="title" id="title" placeholder="Name should atleast 5 characters">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="number" class="form-control" name="qty" id="qty" placeholder="Enter Numbers Only">
							</div>
							<div class="form-group">
