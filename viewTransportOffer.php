			...
			<div class="col-lg-12">
				<table class="table table-striped table-hover">
					...
					<tr>
						...
						<td><a href="selectTransporter.php?id=<?php echo $id;?>"><span class="btn bg-warning">Select Transporter</span></a></td>
					</tr>
					<tbody>
					<?php } ?>
					<?php } ?>
				...
				<form class="" action="viewTransportOffer.php" method="Post" enctype="multipart/form-data">
